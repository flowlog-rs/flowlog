...
impl FlowLogRule {
    ...
    pub fn permute_positive_atoms(&mut self, perm: &[usize]) {
    ...
    #[inline]
    pub fn set_rhs(&mut self, rhs: Vec<Predicate>) {
        self.rhs = rhs;
    }
    ...
    pub fn extract_constants_from_head(&self) -> Result<Vec<ConstType>, ParseError> {
