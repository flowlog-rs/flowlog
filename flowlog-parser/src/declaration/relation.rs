...
impl Relation {
    ...
    pub fn from_parsed_rule_with_registry(
    ...
    #[must_use]
    pub fn from_components(name: &str, attributes: Vec<Attribute>, span: Span) -> Self {
        let raw_name = name.to_string();
    ...
    pub fn set_output_params(&mut self, params: HashMap<String, String>) -> Result<(), ParseError> {
