...
pub(crate) fn aggregation_max_optimize(arity: usize, agg_pos: usize, agg_type: DataType) -> TokenStream {
...
pub(crate) fn aggregation_max_pre_leave(arity: usize, agg_pos: usize, agg_type: DataType) -> TokenStream {
