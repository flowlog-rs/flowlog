...
//!
//! Sharing is keyed on the content-canonical fingerprint each transformation is
//! assigned at materialization; the passes that exploit it — within-stratum
//! dedup, recursion factoring, and the cross-stratum prune — are documented at
//! their definitions (`Transformation::from_info`, [`StratumPlanner`],
//! [`ProgramPlanner`]).
